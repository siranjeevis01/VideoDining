...
namespace VideoDiningApp.Migrations
{
    ...
    [Migration("20250303102739_Add19Table")]
    partial class Add19Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoDiningApp.Models.OrderParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VideoDiningApp.Models.VideoCallParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VideoCallParticipant");
                });
            ...
            modelBuilder.Entity("VideoDiningApp.Models.FriendRequest", b =>
                {
                    b.HasOne("VideoDiningApp.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VideoDiningApp.Models.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("VideoDiningApp.Models.VideoCallParticipant", b =>
                {
                    b.HasOne("VideoDiningApp.Models.VideoCall", null)
                        .WithMany("Participants")
